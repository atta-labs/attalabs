...
### Project management
- **Per-product PM created for Vāda** — `apps/vada-ai/project-management/state.md` + `now.md` committed to main. Phase plan, build state, known bugs, open questions.
- **Per-product PM created for Cetana** — `apps/cetana-ai/project-management/state.md` + `now.md` committed to main. CLI ladder, architecture, locked decisions.
- Herald already had per-product PM from June 1.
