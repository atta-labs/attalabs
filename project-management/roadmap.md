...
- ✅ **F5: V0.5 Step 1 — CLI scaffold + `cetana init`.** Shipped 2026-05-12 (PR #<to-fill>). `apps/cetana-ai/cli/` package. Interactive config wizard, hierarchical config, heartbeat-based CRASHED detection, 25 tests. Install gate (D-021) verified.
