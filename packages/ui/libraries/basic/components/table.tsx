// Wraps basic's own installed Table in the shared scrollable-table wrapper
...
// pinned header carries its own — `border-b` matches basic's `border-b` rows.
import { makeScrollableTable } from '../../../lib/scrollable-table'
import { Table as InstalledTable } from '../installed/table'

const STICKY_HEADER =
  '@min-[780px]/tbl:[&_thead_th]:sticky @min-[780px]/tbl:[&_thead_th]:top-0 @min-[780px]/tbl:[&_thead_th]:z-10 @min-[780px]/tbl:[&_thead_th]:bg-card @min-[780px]/tbl:[&_thead_th]:shadow-[inset_0_-1px_0_0_color-mix(in_oklab,var(--border)_60%,transparent)]'
