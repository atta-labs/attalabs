...
import type { ToastContextType, ToastData, ToastPosition, ToastProviderProps, ToastType } from '@atta/ui/types'
...
export function ToastProvider({ children, defaultPosition = 'bottom-right' }: ToastProviderProps) {
  ...
  const contextValue: ToastContextType = {
    ...
    errorToast: (title, message?, duration = 5000, position?) => addToast('error', title, message, duration, position),
