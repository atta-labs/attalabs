...
const STICKY_HEADER =
  '@min-[780px]/tbl:[&_thead_th]:sticky @min-[780px]/tbl:[&_thead_th]:top-0 @min-[780px]/tbl:[&_thead_th]:z-10 @min-[780px]/tbl:[&_thead_th]:bg-card @min-[780px]/tbl:[&_thead_th]:shadow-[inset_0_-2px_0_0_var(--border)]'
