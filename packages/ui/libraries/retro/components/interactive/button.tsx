...
//
// retro is now the Radix flavor of retroui: the installed Button supports
// `asChild` natively (Radix Slot), so no adapter is needed — asChild flows
// straight through `...props`. cursor-pointer is already baked into the
// installed cva base string, so this wrapper only bakes in leading-none.
