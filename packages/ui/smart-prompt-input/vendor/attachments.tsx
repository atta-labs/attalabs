...
import { Button } from '../../libraries/basic/installed/button'
...
const renderAttachmentImage = (url: string, filename: string | undefined, isGrid: boolean) =>
  isGrid ? (
    // biome-ignore lint/performance/noImgElement: blob/data URL from file attachment, not optimisable via next/image
