 ...
 * Shared across all Atta AI products. Adapted from Summon's font-loader.
 */

import type { ThemeTypography } from '../types'

const GOOGLE_FONTS_BASE = 'https://fonts.googleapis.com/css2'
const FONT_LINK_ID = 'atta-theme-fonts'
...
function collectFontNames(typography: ThemeTypography): string[] {
...
export function getGoogleFontsUrl(typography: ThemeTypography): string | null {
  const fontsToLoad = collectFontNames(typography)
