...
function resolveModel(provider: VendorId, modelId: string, apiKey: string): LanguageModel {
  switch (provider) {
    case 'anthropic':
    ...
    default: {
      // All openai-compat vendors: openai, groq, xai, deepseek, cerebras, mistral, together, fireworks.
      // createOpenAI accepts a custom baseURL for any OpenAI-compatible API.
