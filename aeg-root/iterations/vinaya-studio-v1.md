...
|---|----------------------------------------------------------------|-------|------------|------------------------------------------|----------------|
| 1 | Copy apps/aeg/web → apps/vinaya/web, rename to Vinaya Studio  | #388  | vinaya     | aeg-governance-hardening #368, aeg-governance-hardening #372 | — |
...
- **Task 1 waits for `aeg-governance-hardening` #368 (task 26) + #372 (task 28)** — both
  reshape the exact Studio surface being copied (the TL-flagged moving target; resolved:
  wait, don't fork).
