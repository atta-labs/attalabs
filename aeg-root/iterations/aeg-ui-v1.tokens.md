...
**Backfill policy:** the per-role turn-end obligation is introduced in task 9 (this iteration). Rows for prior tasks in this iteration (tasks 1, 2, 4, 7) are not backfilled — those turns predate the obligation, and inventing numbers would falsify the ledger. The ledger starts here.
