# Tranche: aeg-studio-cleanup — July 2026
Lifecycle: complete

Goal (execution, not roadmap-why): curate AEG Studio's UI surface — add missing
canonical reference content, remove unwanted tranche-view surfaces (dependency
...
| 4 | Exclude tranche execution files from docs nav                | #292  | aeg, aeg-core | aeg-consolidation #265 | —  |
...
- Task 1 (#287) has no dependency on #265 — it adds new, uncontroversially-canonical
  ...
  cross-tranche notes as the anticipated destination for docs-curation work; this is
  this tranche's first real task, seeded ahead of that larger, #265-gated one.
...
- Tasks 2 and 3 have no cross-tranche or intra-tranche dependencies; fully
...
- Runs concurrently with `aeg-consolidation` and `aeg-governance-hardening` (both active,
  ...
  AEG Studio files or this tranche's own topology; neither in-flight tranche's
