...
Items 4 and 5 read live forge state. Items 3 and 6 read the iteration topology file. You never write status anywhere — opening your branch and PR *is* the status. (See `iterations/README.md` §3, §8.)
