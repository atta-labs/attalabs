...
7. **Lock awareness.** If the diff touches an area governed by a `Lock: YES` decision (`docs/decisions-legacy.md`), confirm the brief acknowledged it.
