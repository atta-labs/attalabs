...
export function CreateThemeDialog({ open, onOpenChange, project }: CreateThemeDialogProps) {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      try {
        const result = await createThemeAction(project, trimmedName, description.trim() || undefined)
        reset()
        onOpenChange(false)
        router.push(`/${project}/themes/${result._id}/edit`)
      } catch (err) {
