...
- ~~**`executor-protocol` should chain to `roles/developer.md`.**~~ **Dispatched** — aeg-governance-hardening #266: `.claude/skills/executor-protocol/SKILL.md` now opens with "read `aeg-root/roles/developer.md` first."
