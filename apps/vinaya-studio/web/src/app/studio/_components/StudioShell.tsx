...
import { StudioSidebarHost, type StudioProjectLink } from './StudioSidebar'
 ...
 */
export function StudioShell({ projectLinks, children }: { projectLinks: StudioProjectLink[]; children: ReactNode }) {
  return (
    <Flex className='h-[calc(100dvh-3.5rem)] w-full flex-col overflow-hidden lg:flex-row'>
      <StudioSidebarHost projectLinks={projectLinks} />
