...
export function DeliberateSection(props: DeliberateSectionProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'min-h-[calc(100dvh-3.5rem)] flex flex-col items-center justify-center transition-all duration-300',
      ...
      <div
        className={cn(
          ...
          !isActive && 'pointer-events-none select-none opacity-0 absolute inset-0'
        )}
        aria-hidden={!isActive}
      >
