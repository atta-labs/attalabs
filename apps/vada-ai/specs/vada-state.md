...
Council teams added (vada-production-v1, branch `task/vada-production-v1/council-teams`). Two new YAML specs landed under `packages/agents/vada-deliberation/yamls/`:
