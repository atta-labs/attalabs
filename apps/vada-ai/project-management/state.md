...
**Purpose:** Per-product snapshot for Vāda. Agents working in `apps/vada-ai/` read this before starting any task. Root `project-management/state.md` has full ecosystem context.
