> **Historical record.** This is the original handoff brief that produced `apps/vinaya/web`; it is kept as written and describes the repo as it stood at authoring time. The old AEG Studio app it refers to was deleted outright, so its path citations have been dropped — nothing else here has been restated.
