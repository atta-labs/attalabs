...
export const CONFIG_REFERENCE: readonly ConfigField[] = [
  ...
  },
  {
    ...
    semantics: [
      ...
      'Resolved from the PR’s BASE branch, never the PR’s own working tree — a PR that edits this field takes effect only for PRs opened after it merges, not for itself. Adding someone to `principals` therefore still requires an existing principal’s approval, same as any other change.'
    ],
