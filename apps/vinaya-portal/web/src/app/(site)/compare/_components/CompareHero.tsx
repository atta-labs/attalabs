  ...
  return (
    <LandingSection id='hero' background='bg-background text-foreground' py='spacious'>
      ...
      <Heading
        level={1}
        weight='normal'
        className='mt-5 max-w-[20ch] text-balance font-serif text-4xl leading-tight tracking-tight sm:text-5xl lg:text-6xl'
      >
        <LetterReveal text='Governance means something that runs when the rules file is ignored.' />
      </Heading>
      <Text className='mt-8 max-w-[52ch] text-balance text-xl leading-relaxed text-muted-foreground'>
