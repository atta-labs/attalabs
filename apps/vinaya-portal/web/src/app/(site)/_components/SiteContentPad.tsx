 ...
 * it below the window's bottom edge by the same amount (a 63px container padding puts the
 * hero's sticky `top` at 63px instead of 0). Padding has to live on a plain, non-scrolling
 * wrapper one level in, and skip the hero route entirely.
 */
