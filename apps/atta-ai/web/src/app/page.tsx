...
export default function AttaPortal() {
  return (
    <>
      ...
      {/* Content (renders inside layout's <main>) */}
      <div className='relative z-10 container mx-auto px-6 pt-32 pb-32'>
        ...
        <section className='flex flex-col items-center text-center max-w-4xl mx-auto mb-40 animate-in fade-in slide-in-from-bottom-4 duration-1000'>
          ...
          <Text as='p' className='text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl leading-relaxed'>
            The only AI ecosystem built to put every intelligence to work — together. Preserve your memory, connect your
            tools, and orchestrate your mind.
          </Text>
        ...
        <section className='mb-40 scroll-mt-24' id='ecosystem'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            ...
            <Card className='group border-border/40 bg-background/40 backdrop-blur-sm hover:bg-background/80 transition-all duration-500'>
              ...
              <CardContent>
                <Text as='p' className='text-muted-foreground leading-relaxed mb-8'>
                  Connect specialized agents like Herald, GitHub, and Google Maps directly into your thinking sessions.
                  Live context, zero copy-pasting.
                </Text>
                <Button variant='link' className='px-0 text-primary'>
              ...
              <div className='flex gap-6'>
                ...
                <div>
                  ...
                  <Text as='p' className='text-muted-foreground leading-relaxed'>
                    Your accepted conclusions are stored permanently in a semantic database. They surface automatically
