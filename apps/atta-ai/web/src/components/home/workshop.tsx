    ...
    <section className='bg-muted/30 py-24'>
      <div className='mx-auto max-w-2xl px-6'>
        ...
        <Text as='p' className='mb-6 text-base leading-relaxed text-muted-foreground'>
          AttaLabs is where Atta is being built in public. Each component ships when it's useful and
          remains part of the lab. Vāda is in active use. Vitakka is in scaffold. Atta will
          eventually move to its own home as the composed product matures.
        </Text>
