 ...
 * `aeg-root/iterations/completed/<slug>.md` only for the small grandfathered
 * set of pre-Milestone-era legacy iterations with no Milestone at all
 * (`packages/aeg-core/src/no-disk-state-gate.ts`) — then
